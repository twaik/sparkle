...
{
    {0, 0, 4, 4, 9, "Esc"},
    {5, 0, 4, 4, 67, "F1"}, {9, 0, 4, 4, 68, "F2"}, {13, 0, 4, 4, 69, "F3"}, {17, 0, 4, 4, 70, "F4"},
    {21, 0, 4, 4, 71, "F5"}, {25, 0, 4, 4, 72, "F6"}, {29, 0, 4, 4, 73, "F7"}, {33, 0, 4, 4, 74, "F8"},
    {37, 0, 4, 4, 75, "F9"}, {41, 0, 4, 4, 76, "F10"}, {45, 0, 4, 4, 95, "F11"}, {49, 0, 4, 4, 96, "F12"},
    
    {0, 5, 4, 4, 49, "~\n`"}, {4, 5, 4, 4, 10, "!\n1"}, {8, 5, 4, 4, 11, "@\n2"}, {12, 5, 4, 4, 12, "#\n3"}, {16, 5, 4, 4, 13, "$\n4"}, {20, 5, 4, 4, 14, "%\n5"}, {24, 5, 4, 4, 15, "^\n6"}, {28, 5, 4, 4, 16, "&\n7"}, {32, 5, 4, 4, 17, "*\n8"}, {36, 5, 4, 4, 18, "(\n9"}, {40, 5, 4, 4, 19, ")\n0"}, {44, 5, 4, 4, 20, "_\n-"}, {48, 5, 4, 4, 21, "+\n="},
    {52, 5, 4, 4, 22, "\x1b"},
    
    {0, 9, 4, 4, 23, "Tab"},
    {4, 9, 4, 4, 24, "Q"}, {8, 9, 4, 4, 25, "W"}, {12, 9, 4, 4, 26, "E"}, {16, 9, 4, 4, 27, "R"}, {20, 9, 4, 4, 28, "T"}, {24, 9, 4, 4, 29, "Y"}, {28, 9, 4, 4, 30, "U"}, {32, 9, 4, 4, 31, "I"}, {36, 9, 4, 4, 32, "O"}, {40, 9, 4, 4, 33, "P"}, {44, 9, 4, 4, 34, "{\n["}, {48, 9, 4, 4, 35, "}\n]"},
    {52, 9, 4, 4, 51, "|\n\\"},
    
    {0, 13, 6, 4, 66, "Caps"},
    {6, 13, 4, 4, 38, "A"}, {10, 13, 4, 4, 39, "S"}, {14, 13, 4, 4, 40, "D"}, {18, 13, 4, 4, 41, "F"}, {22, 13, 4, 4, 42, "G"}, {26, 13, 4, 4, 43, "H"}, {30, 13, 4, 4, 44, "J"}, {34, 13, 4, 4, 45, "K"}, {38, 13, 4, 4, 46, "L"}, {42, 13, 4, 4, 47, ":\n;"}, {46, 13, 4, 4, 48, "\"\n\'"},
    {50, 13, 6, 4, 36, "Enter"},
    
    {0, 17, 8, 4, 50, "Shift"},
    {8, 17, 4, 4, 52, "Z"}, {12, 17, 4, 4, 53, "X"}, {16, 17, 4, 4, 54, "C"}, {20, 17, 4, 4, 55, "V"}, {24, 17, 4, 4, 56, "B"}, {28, 17, 4, 4, 57, "N"}, {32, 17, 4, 4, 58, "M"}, {36, 17, 4, 4, 59, "<\n,"}, {40, 17, 4, 4, 60, ">\n."}, {44, 17, 4, 4, 61, "?\n/"},
    {48, 17, 8, 4, 62, "Shift"},
    
    {0, 21, 5, 4, 37, "Ctrl"}, {5, 21, 5, 4, 133, "Win"}, {10, 21, 5, 4, 64, "Alt"},
    {15, 21, 22, 4, 65, ""},
    {37, 21, 5, 4, 108, "Alt"}, {42, 21, 5, 4, 135, "Win"}, {47, 21, 5, 4, 105, "Ctrl"},
    
    {54, 0, 4, 4, 107, "PS"}, {58, 0, 4, 4, 78, "SL"}, {62, 0, 4, 4, 127, "P"},
    
    {57, 5, 4, 4, 110, "H"}, {61, 5, 4, 4, 115, "E"},
    {57, 9, 4, 4, 118, "I"}, {61, 9, 4, 4, 112, "PU"},
    {57, 13, 4, 4, 119, "D"}, {61, 13, 4, 4, 117, "PD"},
    
    {57, 18, 4, 4, 98, "\x18"}, {53, 22, 4, 4, 100, "\x1b"}, {57, 22, 4, 4, 104, "\x19"}, {61, 22, 4, 4, 102, "\x1a"},
};

const int layoutWidth = 66;
const int layoutHeight = 26;
